import{_ as e,n as a,t as i,a as t,d7 as r,x as s,d9 as o,dn as n,dp as d,dq as l,dr as c,df as h,r as g,b as m,ds as u,di as v,dt as C,du as p,dv as w,dw as M,dx as y,dj as I,dy as _,dz as f,db as b,dA as A,dB as j,dC as D,d5 as x,dD as T,s as $,dc as E,dd as k,a4 as L,l as N,dg as z}from"./card-f50ee482.js";import"./image-player-ff6be267.js";import{i as S}from"./media-dimensions-container-22301cea.js";import{L as P,M as Z,a as O,A as V}from"./dispatch-live-error-935a412d.js";import{V as G,h as R,m as W,M as Y}from"./audio-4a740ba1.js";let B=class extends t{constructor(){super(...arguments),this.controls=!1,this._refVideo=r(),this._mediaPlayerController=new G(this,(()=>this._refVideo.value??null),(()=>this.controls))}async getMediaPlayerController(){return this._mediaPlayerController}render(){return s`
      <video
        ${o(this._refVideo)}
        muted
        playsinline
