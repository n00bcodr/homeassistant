...
pn532::PN532OnTagTrigger *pn532_pn532ontagtrigger;
...
void setup() {
  ...
  //   build_path: .esphome/build/tagreader-98db53
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  App.pre_setup("tagreader-98db53", __DATE__ ", " __TIME__, false);
  // switch:
  // button:
  // binary_sensor:
  // text_sensor:
  ...
  //   networks:
  //   - ssid: upadrasta
  //     password: Upadrasta123
  //     id: wifi_wifiap_2
  //     priority: 0.0
  //   use_address: tagreader-98db53.local
  wifi_wificomponent = new wifi::WiFiComponent();
  wifi_wificomponent->set_use_address("tagreader-98db53.local");
  ...
  wifi_wifiap.set_ssid("tagreader-98db53");
  ...
  dashboard_import::set_package_import_url("github://adonno/tagreader/tagreader.yaml");
  // improv_serial:
  ...
  buzzer_enabled->set_name("TagReader Buzzer Enabled");
  ...
  led_enabled->set_name("TagReader LED enabled");
  ...
  //   disabled_by_default: false
  write_tag_random = new button::Button();
  ...
  //   disabled_by_default: false
  cancel_writing = new button::Button();
  ...
  restart_restartbutton->set_name("TagReader Restart");
  ...
  //     trigger_id: pn532_pn532ontagtrigger
  //   update_interval: 1s
  ...
  pn532_pn532ontagtrigger = new pn532::PN532OnTagTrigger();
  pn532_board->register_ontag_trigger(pn532_pn532ontagtrigger);
  automation_9 = new Automation<std::string, nfc::NfcTag>(pn532_pn532ontagtrigger);
  ...
  api_homeassistantservicecallaction->add_data("tag_id", [=](std::string x, nfc::NfcTag tag) -> std::string {
      #line 194 "/config/esphome/.esphome/packages/fa8076cc/tagreader.yaml"
      if (!tag.has_ndef_message()) {
        ESP_LOGD("tagreader", "No NDEF");
        return x;
      }
  ...
  status_statusbinarysensor->set_name("TagReader Status");
  ...
  //   platform: version
  //   hide_timestamp: true
  //   name: TagReader ESPHome Version
  //   entity_category: diagnostic
  //   disabled_by_default: false
  //   icon: mdi:new-box
  ...
  version_versiontextsensor->set_name("TagReader ESPHome Version");
  ...
  wifi_info_ipaddresswifiinfo->set_name("TagReader IP Address");
  wifi_info_ipaddresswifiinfo->set_disabled_by_default(false);
  wifi_info_ipaddresswifiinfo->set_icon("mdi:wifi");
  ...
  wifi_info_ssidwifiinfo->set_name("TagReader Connected SSID");
  wifi_info_ssidwifiinfo->set_disabled_by_default(false);
  wifi_info_ssidwifiinfo->set_icon("mdi:wifi-strength-2");
  ...
  activity_led->set_name("TagReader LED");
  ...
  lambdaaction_2 = new LambdaAction<>([=]() -> void {
      #line 87 "/config/esphome/.esphome/packages/fa8076cc/tagreader.yaml"
      static const char alphanum[] = "0123456789abcdef";
      std::string uri = "https://www.home-assistant.io/tag/";
      for (int i = 0; i < 8; i++)
        uri += alphanum[random_uint32() % (sizeof(alphanum) - 1)];
  ...
  lambdaaction_3 = new LambdaAction<>([=]() -> void {
      #line 120 "/config/esphome/.esphome/packages/fa8076cc/tagreader.yaml"
  ...
  lambdaaction_4 = new LambdaAction<>([=]() -> void {
      #line 132 "/config/esphome/.esphome/packages/fa8076cc/tagreader.yaml"
  ...
  rtttl_playaction_4->set_value([=](std::string song_str) -> std::string {
      #line 157 "/config/esphome/.esphome/packages/fa8076cc/tagreader.yaml"
      return song_str;
  });
  ...
  lambdaaction_5 = new LambdaAction<std::string>([=](std::string tag_id) -> void {
      #line 170 "/config/esphome/.esphome/packages/fa8076cc/tagreader.yaml"
      auto message = new nfc::NdefMessage();
      std::string uri = "https://www.home-assistant.io/tag/";
      uri += tag_id;
      message->add_uri_record(uri);
