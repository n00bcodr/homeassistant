...
void setup() {
  ...
  // esphome:
  //   name: multisensor-2
  //   build_path: .esphome/build/multisensor-2
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  ...
  // wifi:
  //   ap:
  //     ssid: multisensor-2 Fallback Hotspot
  //     password: '123456789'
  //     id: wifi_wifiap
  //     ap_timeout: 1min
  ...
  sensor_sensor->set_name("Multisensor 2 Temperature");
  ...
  sensor_sensor_2->set_name("Multisensor 2 Humidity");
  ...
  adc_adcsensor->set_name("Multisensor 2 Light");
  ...
  sensor_lambdafilter = new sensor::LambdaFilter([=](float x) -> optional<float> {
      #line 43 "/config/esphome/multisensor-2.yaml"
      return (x / 10000.0) * 2000000.0;
  });
  ...
  gpio_gpiobinarysensor->set_name("Multisensor 2 Motion");
  ...
  status_statusbinarysensor->set_name("Multisensor 2 Status");
  ...
  //   platform: version
  //   hide_timestamp: true
  //   name: Multisensor 2 ESPHome Version
  //   entity_category: diagnostic
  //   disabled_by_default: false
  //   icon: mdi:new-box
  ...
  version_versiontextsensor->set_name("Multisensor 2 ESPHome Version");
  ...
  //     update_interval: 1s
  //   ssid:
  //     name: Multisensor 2 Connected SSID
  //     icon: mdi:wifi
  //     entity_category: diagnostic
  //     disabled_by_default: false
  ...
  wifi_info_ipaddresswifiinfo->set_name("Multisensor 2 IP Address");
  ...
  wifi_info_ssidwifiinfo->set_name("Multisensor 2 Connected SSID");
