...
@service
def f1constructorstandings(
    entity_id="sensor.f1_constructor_standings",
    unit_of_measurement=None,
    friendly_name="F1 Constructor Standings",
    icon="mdi:racecar",
):
    if entity_id is None:
        log.error("f1constructorstandings: No Entity ID provided")
        return
    ...
    try:
        ...
        log.error("f1constructorstandings: HTTP Error Occured: {http_err}")
    except Exception as err:
        log.error("f1constructorstandings: Other Error Occured: {err}")
