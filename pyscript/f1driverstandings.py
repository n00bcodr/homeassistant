...
@service
def f1driverstandings(
    entity_id="sensor.f1_driver_standings",
    unit_of_measurement=None,
    friendly_name="F1 Driver Standings",
    icon="mdi:helmet",
):
    if entity_id is None:
        log.error("f1driverstandings: No Entity ID provided")
        return
    ...
    try:
        ...
        log.error("f1driverstandings: HTTP Error Occured: {http_err}")
    except Exception as err:
        log.error("f1driverstandings: Other Error Occured: {err}")
